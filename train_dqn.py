...
from src.utils import read_data, calculate_feature_gaps
...
feature_gaps = calculate_feature_gaps(GLOBAL_X)


wandb.init(
    project="rl_tree_raw_discrete_v1s",
    config={
        "data_name": DATA_NAME,
        "max_depth": MAX_DEPTH,
        "num_gaps":feature_gaps,
    },
    name=f"{DATA_NAME}_depth{MAX_DEPTH}-v2",
)
print(feature_gaps)
